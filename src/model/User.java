...
public class User extends Model {
    ...
    /**
     * The user is inactive if he is deleted. True = active, false is inactive
     */
    ...
    /**
     * This method reads the latest added user
     * @return id of the latest added user.
     */
    public Integer readLatestUser() {
        try {
            this.open();
            this.query("SELECT * FROM \"user\" WHERE id = (SELECT MAX(id) FROM \"user\")");
            this.result();
            this.result.first();
