...
public class Login extends javax.swing.JPanel {
	...
	protected void checkLogin() {
		...
		// Try to login
		// If login succesfull show the dashboard by the user role
		...
		if (Session.get().logIn(username, password)) {
			...
			else if (user.getRoles().get(0).getTitle().equals("barmedewerker")) {
				//Load the barmedewerker Dashboard view
				Application.getInstance().showPanel(new view.barmedewerker.Dashboard());
			} 
			else if (user.getRoles().get(0).getTitle().equals("admin")) {
